...
class User {
    ...
    public function editUser(int $userId, string $newName, string $newLastName, int $newBirthday): bool {
        $sql = "UPDATE users SET user_name = :newName, user_lastname = :newLastName, user_birthday_timestamp = :newBirthday WHERE id = :userId";
        $handler = Application::$storage->get()->prepare($sql);
    ...
    public function deleteUser(int $userId): bool {
        ...
        $handler = Application::$storage->get()->prepare($sql);
        return $handler->execute([':userId' => $userId]);
    }
